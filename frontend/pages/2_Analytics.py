...
# Page Config
st.set_page_config(page_title="EcoSort AI - Sustainability Analytics", page_icon="📊", layout="wide")
...
if df.empty:
    st.info("No historical detection records found to plot. Log some detections on the Detection page first!")
else:
    # Basic Calculations
    ...
    with row1_col1:
        ...
        # Sort so we have standard color mapping or clean gradients
        fig_pie = px.pie(
            cat_counts, 
            values='Count', 
            names='Category',

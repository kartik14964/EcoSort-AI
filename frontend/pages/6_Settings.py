...
if not current_config:
    ...
    with tab1:
        ...
        det_thresh = st.slider("Global Confidence Threshold", 0.0, 1.0,
                                float(current_config.get("detection_threshold", 0.25)), 0.05)
        cam_src = st.text_input("Default Webcam Source Index",
